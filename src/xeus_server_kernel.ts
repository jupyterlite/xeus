...
export class XeusServerKernelBase implements IKernel {
  /**
   * Instantiate a new XeusServerKernelBase
   *
   * @param options The instantiation options for a new XeusServerKernelBase
   */

  xeus_interpreter: any;
  constructor(options: XeusServerKernelBase.IOptions) {
...
/**
 * A namespace for XeusServerKernelBase statics.
 */
export namespace XeusServerKernelBase {
  /**
